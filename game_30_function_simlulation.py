        ...
        if event.type == pygame.QUIT:
            ...
            if button2_clicked:
                ...
                if stats.game_score == 0:
                    ...
                    t1, timestamp1 = random_painting2(numbers[stats.game_score], self, stats.game_score)
                    stats.game_score = stats.game_score + 1
                elif stats.game_score == 12:
                    t2, timestamp2 = random_painting2(numbers[stats.game_score], self, stats.game_score)
                    stats.game_score = stats.game_score + 1
                elif stats.game_score == 13:
                    t3, timestamp3 = random_painting2(numbers[stats.game_score], self, stats.game_score)
                    stats.game_score = stats.game_score + 1
                elif stats.game_score == 14:
                    t4, timestamp4 = random_painting2(numbers[stats.game_score], self, stats.game_score)
                    stats.game_score = stats.game_score + 1
                elif stats.game_score == 15:
                    t5, timestamp5 = random_painting2(numbers[stats.game_score], self, stats.game_score)
                    stats.game_score = stats.game_score + 1
                elif stats.game_score == 16:
                    t6, timestamp6 = random_painting2(numbers[stats.game_score], self, stats.game_score)
                    stats.game_score = stats.game_score + 1
                elif stats.game_score == 17:
                    t7, timestamp7 = random_painting2(numbers[stats.game_score], self, stats.game_score)
                    stats.game_score = stats.game_score + 1
                elif stats.game_score == 18:
                    t8, timestamp8 = random_painting2(numbers[stats.game_score], self, stats.game_score)
                    stats.game_score = stats.game_score + 1
