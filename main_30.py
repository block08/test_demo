...
class Game:
    ...
    def run(self):
        global paused, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20, t21, t22, t23, t24, t25, t26, t27, t28, t29, t30, t31, timestamp1, timestamp2, timestamp3, timestamp4, timestamp5, timestamp6, timestamp7, timestamp8, timestamp9, timestamp10, timestamp11, timestamp12, timestamp13, timestamp14, timestamp15, timestamp16, timestamp17, timestamp18, timestamp19, timestamp20, timestamp21, timestamp22, timestamp23, timestamp24, timestamp25, timestamp26, timestamp27, timestamp28, timestamp29, timestamp30
        settings = Settings()
        stats = GameStats(settings)
        t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20, t21, t22, t23, t24, t25, t26, t27, t28, t29, t30, t31 = [None] * 31  # 初始化 t1 到 t9
        timestamp1, timestamp2, timestamp3, timestamp4, timestamp5, timestamp6, timestamp7, timestamp8, timestamp9, timestamp10, timestamp11, timestamp12, timestamp13, timestamp14, timestamp15, timestamp16, timestamp17, timestamp18, timestamp19, timestamp20, timestamp21, timestamp22, timestamp23, timestamp24, timestamp25, timestamp26, timestamp27, timestamp28, timestamp29, timestamp30 = [None] * 30  # 初始化 timestamp1 到 timestamp30
        ...
        while running1:
            ...
            # 按钮功能绑定
            (
            paused, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20, t21, t22,
            t23, t24, t25, t26, t27, t28, t29, t30, t31, timestamp1, timestamp2, timestamp3, timestamp4, timestamp5,
            timestamp6, timestamp7, timestamp8, timestamp9, timestamp10, timestamp11, timestamp12, timestamp13,
            timestamp14, timestamp15, timestamp16, timestamp17, timestamp18, timestamp19, timestamp20, timestamp21,
            timestamp22, timestamp23, timestamp24, timestamp25, timestamp26, timestamp27, timestamp28, timestamp29,
            timestamp30) = (
                gf.check_events(self, stats, paint_button, next_button,
                                exit_button, numbers, paused, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13,
                                t14, t15, t16, t17, t18, t19, t20, t21, t22, t23, t24, t25, t26, t27, t28, t29, t30,
                                t31, timestamp1, timestamp2, timestamp3, timestamp4, timestamp5, timestamp6, timestamp7,
                                timestamp8, timestamp9, timestamp10, timestamp11, timestamp12, timestamp13, timestamp14,
                                timestamp15, timestamp16, timestamp17, timestamp18, timestamp19, timestamp20,
                                timestamp21, timestamp22, timestamp23, timestamp24, timestamp25, timestamp26,
                                timestamp27, timestamp28, timestamp29, timestamp30))
            ...
            if paused:
                ...
                for i in range(1, 31):
                    if stats.game_score == i:
                        step_button.text = f"{i} / 30"
                if 0 < stats.game_score < 29:
                    next_button.text = "下一张"
                if stats.game_score == 29:
                    next_button.text = "完成"
                gf.update_screen(user_button)
                gf.update_screen(paint_button)
                gf.update_screen(next_button)
                ...
                self.level.run_30(dt, stats, numbers, self.screen)
        ...
        numbers2 = random.sample(range(1, 31), 30)
        ...
        while running3:
            ...
            # 按钮功能绑定
            (
                paused, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20, t21,
                t22,
                t23, t24, t25, t26, t27, t28, t29, t30, t31, timestamp1, timestamp2, timestamp3, timestamp4, timestamp5,
                timestamp6, timestamp7, timestamp8, timestamp9, timestamp10, timestamp11, timestamp12, timestamp13,
                timestamp14, timestamp15, timestamp16, timestamp17, timestamp18, timestamp19, timestamp20, timestamp21,
                timestamp22, timestamp23, timestamp24, timestamp25, timestamp26, timestamp27, timestamp28, timestamp29,
                timestamp30) = (
                gf.check_events(self, stats, paint_button2, next_button2, exit_button2, numbers2, paused, t1, t2, t3, t4,
            ...
            if paused:
                ...
                for i in range(1, 31):
                    if stats.game_score == i + 33:
                        step_button2.text = f"{i} / 30"
                if 33 < stats.game_score < 63:
                    next_button2.text = "下一张"
                if stats.game_score == 63:
                ...
                gf.update_screen(step_button2)
                # 更新画面，一定要写在while循环的最后
                self.level.run2_30(dt, stats, numbers2, self.screen)

                pygame.display.update()
                if stats.game_score == 64:
                    font = pygame.font.Font('font/STXINGKA.TTF', 100)  # 设置字体大小为100
                    ...
                    pygame.display.update()
                    stats.game_score += 1
                if stats.game_score == 65:
                    next_button2.text = "结束"

                gf.update_screen(next_button2)
                if stats.game_score == 66:
                    self.screen.fill('white')
                    break

        numbers3 = random.sample(range(1, 31), 30)
        ...
        while running5:
            ...
            (
                ...
                timestamp22, timestamp23, timestamp24, timestamp25, timestamp26, timestamp27, timestamp28, timestamp29,
                timestamp30) = (
                gf.check_events(self, stats, paint_button3, next_button3, exit_button3, numbers3, paused, t1, t2, t3,
                                t4,
                                t5, t6, t7, t8, t9, t10, t11, t12, t13,
                                t14, t15, t16, t17, t18, t19, t20, t21, t22, t23, t24, t25, t26, t27, t28, t29, t30,
                                t31, timestamp1, timestamp2, timestamp3, timestamp4, timestamp5, timestamp6, timestamp7,
            ...
            if paused:
                ...
                for i in range(1, 31):
                    if stats.game_score == i + 66:
                        step_button3.text = f"{i} / 30"
                if 66 < stats.game_score < 96:
                    next_button3.text = "下一张"
                if stats.game_score == 96:
                ...
                gf.update_screen(step_button3)
                # 更新画面，一定要写在while循环的最后
                self.level.run3_30(dt, stats, numbers3, self.screen)
                pygame.display.update()

                if stats.game_score == 97:
                    font = pygame.font.Font('font/STXINGKA.TTF', 100)  # 设置字体大小为100
                    ...
                    pygame.display.update()
                    stats.game_score += 1
                if stats.game_score == 98:
                    next_button3.text = "结束"

                gf.update_screen(next_button3)
                if stats.game_score == 99:
                    self.screen.fill('white')
                    break
        self.screen.fill('white')
