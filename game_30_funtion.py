        ...
        if event.type == pygame.QUIT:
            ...
            if button2_clicked:
                ...
                if stats.game_score == 0:
                    ...
                    t31 = pygame.time.get_ticks() / 1000
                    pygame.image.save(self.screen, "./output_image/post_screenshot29.png")
                    stats.game_score = stats.game_score + 1
                    ...
                    t31 = pygame.time.get_ticks() / 1000
                    pygame.image.save(self.screen, "./output2_image/post_screenshot29.png")
                    stats.game_score = stats.game_score + 1
                    ...
                    t31 = pygame.time.get_ticks() / 1000
                    pygame.image.save(self.screen, "./output3_image/post_screenshot29.png")
                    stats.game_score = stats.game_score + 1
